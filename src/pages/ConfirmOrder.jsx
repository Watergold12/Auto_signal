...
function ConfirmOrder() {
  ...
  const orderData =
    location.state || data.orderConfirmation;
  ...
  return (
    <AppShell
      eyebrow="Signal desk / NIFTY 50 / Review"
        ...
        <section className="confirmation-layout">
          <article className="confirmation-card">
            ...
            <div className="confirmation-grid">
              ...
              <div>
                <span>Product</span>
                <strong>{orderData.product}</strong>
              </div>
              ...
              <div>
                ...
                <strong>{orderData.entryPrice}</strong>
              </div>
            </div>
          ...
          <aside className="submit-panel">
            ...
            <p>
              This order will be placed with
              Trade Smart using your connected
              broker session.
            </p>
